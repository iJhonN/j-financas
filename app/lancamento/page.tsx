        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="space-y-1 relative">
            ...
            <button 
              ...
              className="w-full p-3 bg-slate-800 rounded-lg border border-slate-700 flex items-center justify-between active:scale-95 transition-all"
            >
